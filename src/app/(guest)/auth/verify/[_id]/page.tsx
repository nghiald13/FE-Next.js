        ...
        <>
            ...
            < div className="grid lg:grid-cols-3 justify-center" >
                ...
                <div className="hidden lg:block" >
                    <img
                        className="h-full"
                        src="https://images.unsplash.com/photo-1592002414452-3a8cec0e7a79?q=80&w=689&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    />
                </div>
